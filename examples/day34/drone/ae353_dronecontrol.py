...
class Controller:
    def __init__(self):
        ...
        self.dt = 0.01
        self.variables_to_log = ['xhat', 'xdes', 'ring', 't_controller', 'count']
    ...
    def run(
        ...
        # Get xdes and udes
        self.xdes, self.udes = self.get_xdes_and_udes(self.count * self.dt, self.xhat, p_x_ring, p_y_ring, p_z_ring)
        
        # Update current time and count
        self.t_controller += self.dt
        self.count += 1
